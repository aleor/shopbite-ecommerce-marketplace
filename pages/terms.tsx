...
const Terms = () => {
  const expandedItems = [...Array.from(Array(33).keys())];
    ...
    return (
      <Box pt="1">
        <Accordion defaultIndex={expandedItems} allowMultiple>
          <SectionItem>
            <SectionHeader>General Terms</SectionHeader>
            <SectionContent>
              <Box>
                By accessing and placing an order with Shopbite.co, you confirm
                ...
                communication between you and Shopbite.co.
              </Box>
              <br />
              <Box>
                Under no circumstances shall Shopbite.co team be liable for any
                ...
                site, even if Shopbite.co team or an authorized representative
              ...
              <br />
              <Box>
                Shopbite.co will not be responsible for any outcome that may
          ...
          <SectionItem>
            ...
            <SectionContent>
              <Box>
                Shopbite.co grants you a revocable, non-exclusive,
              ...
              <Box>
                ...
                Shopbite.co (referred to in these Terms & Conditions as
                "Shopbite.co", "us", "we" or "our"), the provider of the
                Shopbite.co website and the services accessible from the
                Shopbite.co website (which are collectively referred to in these
                Terms & Conditions as the "Shopbite.co Service").
              </Box>
              <br />
              <Box>
                ...
                Shopbite.co Service. In these Terms & Conditions, "you" refers
            ...
            <SectionContent>
              ...
              <List>
                ...
                <li>
                  ...
                  notice of copyright or trademark) of Shopbite.co or its
          ...
          <SectionItem>
            <SectionHeader>Return and Refund Policy</SectionHeader>
            <SectionContent>
              <Box>
                Thanks for shopping at Shopbite.co. We appreciate the fact that
              ...
              <Box>
                ...
                that apply to transactions at Shopbite.co. We’ll be as brief as
                our attorneys will allow. The main thing to remember is that by
                placing an order or making a purchase at Shopbite.co, you agree
                to the terms along with Shopbite.co."’s" Privacy Policy.
              </Box>
              <br />
              <Box>
          ...
          <SectionItem>
            <SectionHeader>Your Suggestions</SectionHeader>
            <SectionContent>
              <Box>
                Any feedback, comments, ideas, improvements or suggestions
                (collectively, "Suggestions") provided by you to Shopbite.co
                with respect to the website shall remain the sole and exclusive
                property of Shopbite.co.
              </Box>
              <br />
              <Box>
                Shopbite.co shall be free to use, copy, modify, publish, or
          ...
          <SectionItem>
            <SectionHeader>Links to Other Websites or Platforms</SectionHeader>
            <SectionContent>
              This Terms & Conditions applies only to the Services. The Services
              may contain links to other websites or platforms not operated or
              ...
              our Terms & Conditions are no longer in effect. Your browsing and
              interaction on any other website, including those that have a link
              on our platform, is subject to that website’s own rules and
          ...
          <SectionItem>
            <SectionHeader>Changes To Our Terms & Conditions</SectionHeader>
            <SectionContent>
              <Box>
                You acknowledge and agree that Shopbite.co may stop (permanently
                or temporarily) providing the Service (or any features within
                the Service) to you or to users generally at Shopbite.co’s sole
                discretion, without prior notice to you. You may stop using the
                Service at any time. You do not need to specifically inform
                Shopbite.co when you stop using the Service. You acknowledge and
                agree that if Shopbite.co disables access to your account, you
          ...
          <SectionItem>
            <SectionHeader>Modifications to Our website</SectionHeader>
            <SectionContent>
              Shopbite.co reserves the right to modify, suspend or discontinue,
          ...
          <SectionItem>
            <SectionHeader>Updates to Our website</SectionHeader>
            <SectionContent>
              <Box>
                Shopbite.co may from time to time provide enhancements or
              ...
              <Box>
                ...
                functionalities of the website. You agree that Shopbite.co has
          ...
          <SectionItem>
            ...
            <SectionContent>
              ...
              <br />
              <Box>
                Shopbite.co may, in its sole discretion, at any time and for any
              ...
              <Box>
                ...
                from Shopbite.co, in the event that you fail to comply with any
              ...
              <Box>
                ...
                Shopbite.co's rights or remedies at law or in equity in case of
          ...
          <SectionItem>
            <SectionHeader>Copyright Infringement Notice</SectionHeader>
            <SectionContent>
          ...
          <SectionItem>
            ...
            <SectionContent>
              You agree to indemnify and hold Shopbite.co and its parents,
          ...
          <SectionItem>
            ...
            <SectionContent>
              <Box>
                ...
                practice. Without limitation to the foregoing, Shopbite.co
              ...
              <br />
              <Box>
                Without limiting the foregoing, neither Shopbite.co nor any
                Shopbite.co's provider makes any representation or warranty of
                ...
                content, or e-mails sent from or on behalf of Shopbite.co are
          ...
          <SectionItem>
            ...
            <SectionContent>
              <Box>
                ...
                liability of Shopbite.co and any of its suppliers under any
              ...
              <Box>
                ...
                shall Shopbite.co or its suppliers be liable for any special,
                ...
                Agreement), even if Shopbite.co or any supplier has been advised
          ...
          <SectionItem>
            <SectionHeader>Severability</SectionHeader>
            <SectionContent>
              <Box>
              ...
              <Box>
                ...
                legal notices published by Shopbite.co on the Services, shall
                constitute the entire agreement between you and Shopbite.co
                ...
                term or any other term, and Shopbite.co."’s" failure to assert
                any right or provision under this Agreement shall not constitute
                a waiver of such right or provision. YOU AND Shopbite.co AGREE
          ...
          <SectionItem>
            <SectionHeader>Waiver</SectionHeader>
            <SectionContent>
              <Box>
          ...
          <SectionItem>
            <SectionHeader>Amendments to this Agreement</SectionHeader>
            <SectionContent>
              <Box>
                Shopbite.co reserves the right, at its sole discretion, to
          ...
          <SectionItem>
            ...
            <SectionContent>
              <Box>
                ...
                Shopbite.co regarding your use of the website and supersedes all
              ...
              <Box>
                ...
                when you use or purchase other Shopbite.co's services, which
                Shopbite.co will provide to you at the time of such use or
                purchase.
              </Box>
            </SectionContent>
          </SectionItem>
          ...
          <SectionItem>
            <SectionHeader>Updates to Our Terms</SectionHeader>
            <SectionContent>
          ...
          <SectionItem>
            ...
            <SectionContent>
              ...
              arrangement thereof), are owned by Shopbite.co, its licensors or
              other providers of such material and are protected by Indonesia
              ...
              prior written permission of Shopbite.co, unless and except as is
          ...
          <SectionItem>
            <SectionHeader>Agreement to Arbitrate</SectionHeader>
            <SectionContent>
              ...
              REGARDING THE ENFORCEMENT OR VALIDITY OF YOUR OR Shopbite.co."’s"
              INTELLECTUAL PROPERTY RIGHTS. The term “dispute” means any
              dispute, action, or other controversy between you and Shopbite.co
          ...
          <SectionItem>
            <SectionHeader>Notice of Dispute</SectionHeader>
            <SectionContent>
              In the event of a dispute, you or Shopbite.co must give the other
              ...
              support@shopbite.co. Shopbite.co will send any Notice of Dispute to
              you by mail to your address if we have it, or otherwise to your
              email address. You and Shopbite.co will attempt to resolve any
              dispute through informal negotiation within sixty (60) days from
              the date the Notice of Dispute is sent. After sixty (60) days, you
              or Shopbite.co may commence arbitration.
            </SectionContent>
          </SectionItem>

          <SectionItem>
            <SectionHeader>Binding Arbitration</SectionHeader>
            <SectionContent>
              If you and Shopbite.co don’t resolve any dispute by informal
          ...
          <SectionItem>
            <SectionHeader>Submissions and Privacy</SectionHeader>
            <SectionContent>
              ...
              property of Shopbite.co without any compensation or credit to you
              whatsoever. Shopbite.co and its affiliates shall have no
          ...
          <SectionItem>
            ...
            <SectionContent>
              Shopbite.co may, from time to time, include contests, promotions,
          ...
          <SectionItem>
            <SectionHeader>Typographical Errors</SectionHeader>
            <SectionContent>
          ...
          <SectionItem>
            ...
            <SectionContent>
              ...
              signed by an authorized representative of Shopbite.co. Shopbite.co
              ...
              breach or anticipatory breach by you. Shopbite.co operates and
              controls the Shopbite.co Service from its offices in Indonesia.
              ...
              Accordingly, those persons who choose to access the Shopbite.co
              ...
              include and incorporate the Shopbite.co Privacy Policy) contains
              the entire understanding, and supersedes all prior understandings,
              between you and Shopbite.co concerning its subject matter, and
          ...
          <SectionItem>
            ...
            <SectionContent>
              <Box>
                Shopbite.co is not responsible for any content, code or any
                other imprecision.
              </Box>
              <br />
              <Box>Shopbite.co does not provide warranties or guarantees.</Box>
              <br />
              <Box>
                In no event shall Shopbite.co be liable for any special, direct,
              ...
              <br />
              <Box>
                The Shopbite.co Service and its contents are provided "as is"
                and "as available" without any warranty or representations of
                any kind, whether express or implied. Shopbite.co is a
                distributor and not a publisher of the content supplied by third
                parties; as such, Shopbite.co exercises no editorial control
                ...
                via the Shopbite.co Service. Without limiting the foregoing,
                Shopbite.co specifically disclaims all warranties and
                representations in any content transmitted on or in connection
                with the Shopbite.co Service or on sites that may appear as
                links on the Shopbite.co Service, or in the products provided as
                a part of, or otherwise in connection with, the Shopbite.co
                Service, including without limitation any warranties of
                merchantability, fitness for a particular purpose or
                non-infringement of third party rights. No oral advice or
                written information given by Shopbite.co or any of its
                ...
                foregoing, Shopbite.co does not warrant that the Shopbite.co
          ...
          <SectionItem>
            ...
            <SectionContent>
              Don't hesitate to contact us if you have any question to our team
              at:{' '}
